...
def draw_plot(results_json_path,datalist,dataset_name):
    ...
    plt.plot(threshes_precision, precisions_dimp50_rand_all, label='DiMP50_RAND ' + str(precisions_dimp50_rand_all[idx20])[:5])
    ...
    # plt.plot(threshes_precision, precisions_prdimp50_rand_all, label='PrDiMP50_RAND ' + str(precisions_prdimp50_rand_all[idx20])[:5])
    ...
    plt.plot(threshes_success, successes_dimp50_rand_all, label='DiMP50_RAND ' + str(calAUC(successes_dimp50_rand_all))[:5])
    ...
    # plt.plot(threshes_success, successes_prdimp50_rand_all, label='PrDiMP50_RAND ' + str(calAUC(successes_prdimp50_rand_all))[:5])
